    ...
    >
      ...
      <div className="flex justify-center items-center min-h-[calc(100vh-120px)]">
        ...
        >
          ...
          {/* Vault Timer */}
          <Card className="border-white/20 p-5 shadow-lg ring-1 ring-white/10 backdrop-blur-md" style={{ background: 'linear-gradient(135deg, rgba(255, 255, 255, 0.08) 0%, rgba(0, 0, 0, 0.12) 100%)', borderRadius: '8px' }}>
            <div className="flex items-center justify-center gap-2 mb-4">
              <Clock className="w-4 h-4 text-gray-400" />
              <span className="text-gray-400 text-sm font-semibold">Vault Timer</span>
            </div>
            <div className="text-center">
              <div className="text-4xl font-bold text-white mb-1">00 : 04 : 20</div>
